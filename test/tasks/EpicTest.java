...
class EpicTest {
    ...
    Subtask subtask = new Subtask("a", "b", Statuses.NEW, null, 0);
    Subtask subtask1 = new Subtask("a", "b", Statuses.NEW, null, 0);
    Subtask subtask2 = new Subtask("a", "b", Statuses.NEW, null, 0);
